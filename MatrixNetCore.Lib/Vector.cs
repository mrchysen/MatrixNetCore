...
public static class VectorOperations
{
    ...
    /// <returns></returns>
    public static Vector<T> GetColoumnVectorFromMatrix<T>(int j, Matrix<T> matr) where T : INumber<T>
    {
        Vector<T> vec = new(matr.SecondLength);
    ...
    /// <param name="vector"></param>
    /// <returns></returns>
    public static T MaxCoordinate<T>(Vector<T> vector) where T : INumber<T>
    {
        T max = vector[0];
